...
A compromise needs to be found between these two extremes: user-friendly but bespoke and hard-to-use but powerful. In order to find this compromise I am going to present the user with a new type of view of the database that they are already familiar with: a file and directory tree.
